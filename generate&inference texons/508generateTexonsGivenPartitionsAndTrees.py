...
def main():
    ...
    for imageIndex in range(imageNum):
        sampledTree = treeHypothesesSpace[list(np.random.multinomial(1, [1/len(treeHypothesesSpace)] * len(treeHypothesesSpace))).index(1)]
        ...
        sampledPartition = partitionGivenTreeHypothesesSpace[list(np.random.multinomial(1, [1/len(partitionGivenTreeHypothesesSpace)] * len(partitionGivenTreeHypothesesSpace))).index(1)]
