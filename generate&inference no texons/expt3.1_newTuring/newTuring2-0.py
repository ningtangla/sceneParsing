...
class experimentOfDecision():
    ...
    def __call__(self, trialTotalNum, pathOfExperiment):
        ...
        for imgNum in imgTotal:
            ...
            if typeOfAnswer == 2:
                PathOfAnswer = pathOfExperiment + "humanPrior/"
        ...
        timeNow = time.time()
        numpy.savetxt('data/Turing2-0/sub' + str(subjectIndex) + '.txt',numpy.vstack([imageIndexTotal, typeOfAnswerTotal, responseTotal]).T, ['%f', '%f','%f'])
