...
"""
SUBJECT_NUM_LIST = range(1, 26)+range(101, 109)+range(201, 209)+range(301, 308) 
IMG_LIST = []
...
#    alpha_hyper_sample = map(lambda x: np.e**x, logalpha_hyper_sample)
    ...
    print IMG_LIST
    Posterior_Likelihood = posterior(img_num = 2*len(SUBJECT_NUM_LIST))
    ...
    export_IC_CE.to_csv('hyperprior_1.0' + str(GAMMA) +'_' + str(ALPHA_BASE) + '.csv')
