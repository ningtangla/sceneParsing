...
#            nx.write_gpickle(most_like_tree, 'E:/ncrp_infer/human/most_like_tree_alpha'+str(ALPHA_BASE)+'_gamma['+str(GAMMA)+']_'+str(z)+'.gpickle')
...
#    cv2.waitKey()
    cv2.imwrite('E:/ncrp_infer/human/'+str(img_num + 1)+'.png', img_show)
