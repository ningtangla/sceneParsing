...
#    cv2.waitKey()
    cv2.imwrite('E:/ncrp_infer/randommachine/machine'+str(MACHINE_NUM) + '/'+str(img_num + 1)+'.png', img_show)
...
#    print IMG_LIST
    ...
    export_IC_CE.to_csv('informationcontent_conditionalentropy_random_tree.csv')
