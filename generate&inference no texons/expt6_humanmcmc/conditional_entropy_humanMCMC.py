...
def main():           
    ...
    export_IC_CE = pd.DataFrame(IC_CE, columns = ['information_content', 'conditional_entropy'], index = dfIndex)
    ...
    export_IC_CE.to_csv('informationcontent_conditionalentropy_expt6' + str(max(SUB_NUM)) + '.csv')
    print ('okkkkk')
