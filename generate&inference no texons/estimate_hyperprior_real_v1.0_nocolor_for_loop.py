...
class possible_tree_generator():  
    ...
    def __call__(self):
        img_original = cv2.imread('E:/redraw/blank1.0/'+IMG_LIST[self.img_num]+'.png')
...
#    alpha_hyper_sample = map(lambda x: np.e**x, logalpha_hyper_sample)
    ...
    export_IC_CE.to_csv('E:/pic_IC_and_CE/hyperprior_' + str(GAMMA) +'_' + str(ALPHA_BASE) + '.csv')
