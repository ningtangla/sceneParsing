...
#        print 'ttt', table_partion_list, renomalize_parameter
#        c[len(table_partion_list[1]) - 2] = c[len(table_partion_list[1]) - 2] + reduce(op.mul, np.array(probability_table_partion)*np.array(all_combination_guest)*np.array(renomalize_parameter))
#        print c
#        reduce(op.mul, np.array(probability_table_partion)*np.array(all_combination_guest)*np.array(renomalize_parameter))
...
#        f_all_img = 1
        for z in range(47, self.img_num):
#            print z
...
#                        plt.savefig('E:/ncrp_test/'+str(IMG_LIST[z])+'_'  +str(i * num_graph_col + j)+'.png')
#                        plt.close()
...
#                        
#                        tree_graph_img = cv2.imread('E:/ncrp_test/'+str(IMG_LIST[z])+'_'+str(i * num_graph_col + j)+'.png')
...
#    
#    
#            img_to_infer = cv2.imread('E:/human_answer/'+str(IMG_LIST[z])+'.png')
...
#            plt.savefig('E:/ncrp_test/'+str(IMG_LIST[z])+'_hist.png')   
#            plt.close()
#            img_hist = cv2.imread('E:/ncrp_test/'+str(IMG_LIST[z])+'_hist.png')
...
##            cv2.waitKey()
#            cv2.imwrite('E:/ncrp_infer/trees_hist_alpha'+str(ALPHA_BASE)+'_gamma['+str(GAMMA)+']_'+str(IMG_LIST[z])+'.png', img_trees)
#            cv2.destroyAllWindows()
...
#    cv2.namedWindow('inference_demo')
    ...
    img_to_infer = cv2.imread('E:/human_answer/'+str(IMG_LIST[img_num]) +'.png')
...
#    cv2.waitKey()
    cv2.imwrite('E:/ncrp_infer/'+str(img_num + 1)+'.png', img_show)
