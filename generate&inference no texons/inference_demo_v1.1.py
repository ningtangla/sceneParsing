...
#                print cut_point_list
    ...
    def cal_p_table_partion(self, curr_depth_table_partion):
        ...
        print self.flattend_curr_depth_table_partion
        ...
        if self.flattend_curr_depth_table_partion.count(1) != len(self.flattend_curr_depth_table_partion):
            ...
            self.next_depth_index = map(lambda x: map(lambda y: map(lambda z: x[y].index(z), np.array(range(len(self.next_depth_table_partion))) + self.flattend_curr_depth_table_partion.count(1)), range(len(x))), self.permutation_table_partion_index)
            ...
            print '###'
            print self.next_depth_index_num, self.next_depth_table_partion, self.next_depth_table_partion_index, self.next_depth_permutation_index_base 
            print '***'
            ...
            self.next_depth_cut = map(lambda x: map(lambda y: map(self.detect_cut_point_list, self.next_depth_vertex[x][y]), range(len(self.next_depth_vertex[0]))), range(len(self.next_depth_vertex)))
...
#            self.seperate_permutation_index = 
            ...
            print self.next_depth_vertex, self.next_depth_cut
            ...
            self.next_depth_all_vertex_list = np.array(self.next_result_list)[:,:,:,1]
            print self.p_list, self.next_depth_all_vertex_list

            self.permutation_table_partion_index = map(lambda x: map(list, self.next_depth_permutation_index_after_product[x]), range(len(self.next_depth_permutation_index_after_product)))
    ...
    def cal_cut_point_and_corresponding_table_partion2(self, x, y, z):
        ...
        self.t = map(lambda x: self.cal_cut_point_and_corresponding_table_partion3(table_partion[x], cut_point_list[x], cut_propotion_list[x], new_vertex_list[x]), range(len(table_partion)))
...
#        print p
    ...
    def cal_likelihood(self):
        self.c = 0 
        map(self.cal_p_one_table_partion_list, self.all_table_partion_list[11:12])
