...
%     instructionRect = Screen('Rect',instruction);
    ...
    pic_name = [10009,10021,10032,10050,10086,10100,10113,10119,10143,10154,10185,10224,10381,10412,10445,10576,10624,10640,10818,10835];
    temp = 1;
    for i = 1:19
        for j = i + 1:20
            type{temp, 1} = i;
...
%         WaitSecs(0.6+rand*0.4);   %调节trial间间隔时间
    ...
    Screen('Close',w);
    ShowCursor;
    fid=fopen(['Results\','paired_comparision_1_0_',filename,'.txt'],'w');
